    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-white"><a href="#"><i class="fas fa-copyright text-light me-2"></i>PT. Karya Prima Usahatama</a>, All right reserved.</span>
            </div>
            <div class="col-md-6 text-center text-md-end text-white">
                Designed By <a target="_blank" class="border-bottom" href="https://kikiaka.id">KIKIAKA DIGITAL PROJECT</a>
            </div>
        </div>
    </div>
</div>
