         ...
         <div class="row g-4 justify-content-center">
             @foreach ($servicelists as $list)
                 <div class="col-md-6 col-lg-4 col-xl-3 d-flex align-items-stretch wow fadeInUp" data-wow-delay="0.1s">
                     <a href="{{ route('serviceDetail', $list->id) }}" class="w-100 text-decoration-none text-dark">
                         <div class="service-item text-center rounded p-4 w-100 h-100">
                             <div class="service-icon d-inline-block bg-light rounded p-4 mb-4">
                                 <img src="/image/servicelist/{{ $list->image }}" alt="Image" class="img-fluid"
